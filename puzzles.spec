...
Source0  : https://www.chiark.greenend.org.uk/~sgtatham/puzzles/puzzles-20240911.cd97968.tar.gz
...
%prep
%setup -q -n puzzles-20240911.cd97968
cd %{_builddir}/puzzles-20240911.cd97968
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1726163443
mkdir -p clr-build
pushd clr-build
