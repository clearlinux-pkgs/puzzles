...
Source0  : https://www.chiark.greenend.org.uk/~sgtatham/puzzles/puzzles-20241230.79be403.tar.gz
...
%prep
%setup -q -n puzzles-20241230.79be403
cd %{_builddir}/puzzles-20241230.79be403
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1738708413
mkdir -p clr-build
pushd clr-build
