...
Source0  : https://www.chiark.greenend.org.uk/~sgtatham/puzzles/puzzles-20241108.8e83f39.tar.gz
...
%prep
%setup -q -n puzzles-20241108.8e83f39
cd %{_builddir}/puzzles-20241108.8e83f39
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1731099270
mkdir -p clr-build
pushd clr-build
